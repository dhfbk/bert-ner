...
parser.add_argument('-b, --bert', help="BERT model name in Huggingface (default " + defaultBert + ")", required=False, default=defaultBert, metavar="NAME")
...
parser.add_argument('-p, --pad_label', help="Padding label, it must be different from labels in the NER data (default " + str(defaultPaddingLabel) + ")", required=False, default=defaultPaddingLabel, metavar="LBL")
